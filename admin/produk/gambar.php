            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="judul" class="form-control" placeholder="Judul Gambar" required="">
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        {
                            $produk->unggahgambar($_POST['judul'],$_FILES['gambar_produk'],$id_produk);
