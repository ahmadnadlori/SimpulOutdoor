...
<section class="pcoded-main-container">
    <div class="pcoded-content">
                       ...
                       <form method="post">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_pelanggan" placeholder="nama_pelanggan" required="">
                            </div>
                        </div>
                    </div>
        ...
        if (isset($_POST['simpann'])) {
            $penjualan->transaksi_masuk($_POST['tgl_masuk'],$_POST['nama_pelanggan'],$_POST['total_belanja']);
