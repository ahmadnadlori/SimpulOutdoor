				...
				<div class="col-md-9">
					<div class="card">
						<div class="card-body">
							...
							<p class="b"><b>5. </b> Jika sudah sesuai dengan yang ingin anda pesan, langkah selanjutnya pilih paket produk mana yang ingin anda pesan! Masukan jumlah yang ingin anda pesan dan langkah selanjutnya masukan ke keranjang, didalam halaman keranjang anda dapat melihat pilihan produk yang anda pesan, jika anda ingin membeli lebih dari satu produk anda bisa klik Lanjutkan Belanja, jika tidak langsung saja dengan mengklik tombol Checkout untuk melakukan transaksi pesanan anda!</p>
							<center><img class="thumbnail" width="800" id="gambar" src="img-panduan/keranjang.png" alt=""></center>
							<p class="b"><b>6. </b> Jika sudah menyelesaikan tahap checkout, selanjutnya anda akan dialihkan ke halaman nota. Pada halaman nota anda akan diberitahu rincian pesanan anda, jumlah yang harus dibayarkan dan cara pembayaran untuk pesanan anda!</p>
							<center><img class="thumbnail" width="800" id="gambar" src="img-panduan/nota.png" alt=""></center>
							<p class="b"><b>7. </b> Pada halaman cara pembayaran anda akan diberitahu jumlah pembayaran yang harus dibayar, dan transfer ke salah satu rekening Simpul Outdoor!</p>
